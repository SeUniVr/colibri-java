...
public interface Lattice {
	 ...
	 */
	Concept join(Collection<Concept> concepts);
	 ...
	 */
	Concept meet(Collection<Concept> concepts);
	 ...
	 */
	Concept conceptFromObjects(Collection<Comparable> objects) throws IllegalArgumentException;
	 ...
	 */
	Concept conceptFromAttributes(Collection<Comparable> attributes) throws IllegalArgumentException;
	 ...
	 */
	Iterator<Concept> lowerNeighbors(Concept concept);
	 ...
	 */
	Iterator<Concept> upperNeighbors(Concept concept);
	 ...
	 */
	Iterator<Concept> conceptIterator(Traversal trav);
	 ...
	 */
	Iterator<Edge> edgeIterator(Traversal trav);
	 ...
	 */
	Iterator<Edge> violationIterator(int supp, float conf, int diff);
}
