...
public interface ComparableSet extends Set<Comparable>, Comparable, Cloneable {
	 ...
	 * of a class that implements <code>java.colibri.util.Collection</code>
	 ...
	 */
	boolean containsNone(ComparableSet set);
	 ...
	 */
	boolean containsNone(ComparableSet set, Comparable c);
	 ...
	 */
	int compareTo(Object anotherSet);
}
