...
public interface Relation {
	 ...
	 */
	Iterator<Comparable> getObjects(Comparable attribute);
	 ...
	 */
	Iterator<Comparable> getAttributes(Comparable object);
	 ...
	 */
	ComparableSet getObjectSet(Comparable attribute);
	 ...
	 */
	ComparableSet getAttributeSet(Comparable object);
	 ...
	 */
	ComparableSet commonObjects(Collection<Comparable> attributes) throws IllegalArgumentException;
	 ...
	 */
	ComparableSet commonAttributes(Collection<Comparable> objects) throws IllegalArgumentException;
	 ...
	 */
	void add(Comparable object, Comparable attribute) throws ClassCastException, UnsupportedOperationException;
	 ...
	 * @throws UnsupportedOperationException if this relation is write protected.
	 */
	void remove(Comparable object, Comparable attribute) throws UnsupportedOperationException;
	 ...
	 */
	boolean contains(Object object, Object attribute);
}
