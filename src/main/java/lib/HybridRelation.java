...
class HybridRelation implements Relation {
	...
	private final Map<Comparable, ComparableSet> objectMap;
	private final Map<Comparable, ComparableSet> attributeMap;
	
	private final ComparableSet allObjects;
	private final ComparableSet allAttributes;
	
	private final HybridTranslator objectTranslator;
	private final HybridTranslator attributeTranslator;
